...
// Certificate
const privateKey = fs.readFileSync('/etc/letsencrypt/live/akty-cargo.kz/privkey.pem', 'utf8');
const certificate = fs.readFileSync('/etc/letsencrypt/live/akty-cargo.kz/cert.pem', 'utf8');
const ca = fs.readFileSync('/etc/letsencrypt/live/akty-cargo.kz/chain.pem', 'utf8');
